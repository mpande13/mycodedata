...
public class RecordingCompleted {
	...
	public void createIssueForPCM2(Connection connection, String categoryClear, String title, String requestingOrg)
			throws APIException {
		...
		try {
			...
			System.out.println("PCM2 CR Created with ID:-" + itemID);
